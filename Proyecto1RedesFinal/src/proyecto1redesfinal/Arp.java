...
public class Arp {
    ...
    static byte[] macVacia = new byte[] { (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00, (byte) 0x00,
            (byte) 0x00 };
    ...
    public static byte[] arpRequest(byte[] ip, NetworkInterface tarjetaRed) throws IOException {
        ...
        // QUITAR
        System.out.println(
                "Buenos dias estrellitas , la Tierra les dice hola !!!!!!!!!! :D : " + ipOrigen.getHostAddress());
        ...
        while (true) {
            ...
            if (Arrays.equals(paquete.target_protoaddr, ipOrigen.getAddress())
                    && Arrays.equals(ip, paquete.sender_protoaddr)) {
                // TODO
                // QUITAR
            ...
            // Binario.arregloBytesAHexa(paquete.sender_hardaddr, "."));
        }
    }

    public static byte[] arpRequest2(byte[] macHostOrigen, byte[] ipHostOrigen, byte[] macHostDestino,
            byte[] ipHostDestino, short operationARP, EthernetPacket tramaEthernetII, NetworkInterface tarjetaRed)
            throws IOException {
        ...
        // TODO
        // QUITAR
        System.out.println("Buenos dias estrellitas , la Tierra les dice hola !!!!!!!!!! :D : " + Binario.arregloBytesADeci(ipHostOrigen, "."));
        ...
        tramaArp.hlen = 6;
        tramaArp.plen = 4;
        tramaArp.operation = ARPPacket.ARP_REQUEST; // Esperar respuesta profesor TODO
        ...
        while (true) {
            ...
            // si llega un paquete con el target_protoaddr (ip destino) igual a nuestro IPV4
            // retornar su MAC de respuesta
            if (Arrays.equals(paquete.target_protoaddr, ipHostOrigen))
